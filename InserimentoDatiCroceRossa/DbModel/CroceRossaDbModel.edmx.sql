...
-- --------------------------------------------------
-- Date Created: 07/06/2019 13:24:58
...
GO
IF OBJECT_ID(N'[dbo].[FK__Ins__InsIndId__6A30C649]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ins] DROP CONSTRAINT [FK__Ins__InsIndId__6A30C649];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK__Ins__InsSvrFrm__6754599E]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ins] DROP CONSTRAINT [FK__Ins__InsSvrFrm__6754599E];
GO
IF OBJECT_ID(N'[dbo].[FK__Ins__InsSvrTo__68487DD7]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ins] DROP CONSTRAINT [FK__Ins__InsSvrTo__68487DD7];
GO
...
-- Creating foreign key on [InsIndId] in table 'Ins'
ALTER TABLE [dbo].[Ins]
ADD CONSTRAINT [FK__Ins__InsIndId__6A30C649]
    FOREIGN KEY ([InsIndId])
    REFERENCES [dbo].[Ind]
        ([IndOwnId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK__Ins__InsIndId__6A30C649'
CREATE INDEX [IX_FK__Ins__InsIndId__6A30C649]
ON [dbo].[Ins]
    ([InsIndId]);
GO
...
-- Creating foreign key on [InsSvrFrm] in table 'Ins'
ALTER TABLE [dbo].[Ins]
ADD CONSTRAINT [FK__Ins__InsSvrFrm__6754599E]
    FOREIGN KEY ([InsSvrFrm])
    REFERENCES [dbo].[Loc]
        ([LocOwnId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK__Ins__InsSvrFrm__6754599E'
CREATE INDEX [IX_FK__Ins__InsSvrFrm__6754599E]
ON [dbo].[Ins]
    ([InsSvrFrm]);
GO

-- Creating foreign key on [InsSvrTo] in table 'Ins'
ALTER TABLE [dbo].[Ins]
ADD CONSTRAINT [FK__Ins__InsSvrTo__68487DD7]
    FOREIGN KEY ([InsSvrTo])
    REFERENCES [dbo].[Loc]
        ([LocOwnId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK__Ins__InsSvrTo__68487DD7'
CREATE INDEX [IX_FK__Ins__InsSvrTo__68487DD7]
ON [dbo].[Ins]
    ([InsSvrTo]);
GO
